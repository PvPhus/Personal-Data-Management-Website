                                        ...
                                        <tbody>
                                            {currentPageData.map((group, index) => (
                                                <tr key={group.group_id}>
                                                    <td>{index + 1}</td>
                                                    <td>
                                                        <img src={`/resources/images/${group.group_image}`} alt="Group Image" style={{ width: 50, height: 50 }} />
                                                    </td>
                                                    ...
                                                    <td>
                                                        <button className="btn btn-success" onClick={() => handleMember(group.group_id)}>
                                                            List Member
                                                        </button>
                                                        <button className="btn btn-primary" onClick={() => handleData(group.group_id)}>
                                                            List Data
                                                        </button>
                                                        <button className="btn btn-warning" onClick={() => handleDeleteClick(group.group_id)}>
                                                            Delete Group
                                                        </button>
                                                    </td>
                                                </tr>
