    ...
    return (
        <section id="sidebar">
            ...
            <ul className="side-menu">
                ...
                <li>
                    <a href="#"><i className="bx bxs-cloud-upload icon" /> Upload <i className="bx bx-chevron-right icon-right" /></a>
                ...
                <li><a href="#"><i className="bx bxs-cloud icon" />Memory</a></li>
            </ul>
            <div className="ads">
                <div className="wrapper">
                    <a href="#" className="btn-upgrade">Buy Data</a>
                </div>
            </div>
        </section>
    );
